...
/* harmony import */ var _components_Company__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components/Company */ "./src/components/Company.tsx");
...
var getCompanyFromLocalStorage = function getCompanyFromLocalStorage(companyId) {
  var favorites = {};
...
var Company = function Company(_ref) {
  ...
  react__WEBPACK_IMPORTED_MODULE_2___default.a.useEffect(function () {
    var item = getCompanyFromLocalStorage(company.id);
  ...
  react__WEBPACK_IMPORTED_MODULE_2___default.a.useEffect(function () {
    ...
    currentItem['isFavorite'] = _objectSpread({}, company, {
      isFavorite: isFavorite
    });
    favorites[company.id] = currentItem;
    localStorage.setItem('companies', JSON.stringify(favorites));
  }, [isFavorite]);
  return __jsx(_components_Company__WEBPACK_IMPORTED_MODULE_3__["default"], {
    company: company,
    isFavorite: isFavorite,
...
//# sourceMappingURL=[id].js.6f3a5574789a32c100a2.hot-update.js.map